...
export default function RoomTypesCreate({ values }: { values: Values }){
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        post(route('portal.room_types.create'))
    };
        ...
        <MainLayout>
                    ...
                    <Flex justify={{ base: "flex-start", md: "space-between" }} align="center" direction={{ base: "column", md: "row" }}>
                        ...
                        <Breadcrumb.Root>
                            <Breadcrumb.List>
                                ...
                                <Breadcrumb.Separator />
                                <Breadcrumb.Item>
                                    <Breadcrumb.CurrentLink>Create Room Type</Breadcrumb.CurrentLink>
                                </Breadcrumb.Item>
                            </Breadcrumb.List>
                        </Breadcrumb.Root>
                    </Flex>
            ...
            <Container maxW="3xl" mt={4} style={{padding: "0px"}}>
                <form onSubmit={handleSubmit} style={{ width: "100%" }}>
                    <Card.Root size="sm">
                        <Card.Header pb={2}>
                            <Heading _dark={{ color: "gray.300" }} color="gray.700" size="md">Create room type form</Heading>
